...
class MasterService(models.Model):
    master_service_id = models.CharField(max_length=100, primary_key=True)
    master = models.ForeignKey(Master, on_delete=models.CASCADE, related_name='master_services')
    service = models.ForeignKey(Service, on_delete=models.CASCADE, related_name='master_services')

    def __str__(self):
        return f"{self.master.full_name} - {self.service.info}"
